...
# v8
python metrics.py \
    --input ../../runs_none_pretrain/v1_hpmodule_v8/test_results_v3/labels_raw \
    --label ../../../data/plant_height/labels/test_json \
    --save ../../runs_none_pretrain/v1_hpmodule_v8/test_results_v3/raw_yolo.csv

python metrics.py \
    --input ../../runs_none_pretrain/v1_hpmodule_v8/test_results_v3/labels_point_correct \
    --label ../../../data/plant_height/labels/test_json \
    --save ../../runs_none_pretrain/v1_hpmodule_v8/test_results_v3/point_correct_yolo.csv
