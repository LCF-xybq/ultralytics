"""
plant_height_v2.py - Plant height inference and post-processing pipeline
...
Usage:
  python plant_height_v2.py --weight best.pt --data ./images --save_json ./results
  python plant_height_v2.py --weight best.pt --data ./images --save_json ./results --point_correct
"""
